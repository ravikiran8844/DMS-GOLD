...
$(function () {
    ...
    $(document).ready(function () {
        // Attach click event to the message-toggle
        $('#message-toggle').on('click', function () {
            // Fetch order details when the toggle is clicked
            $('.notification-item').on('click', function () {
                var orderId = $(this).data('order-id');
                
                // Use orderId to fetch order details from the server
                $.get('/order-details/' + orderId, function (orderDetails) {
                    // Use orderDetails to display information as needed
                    console.log(orderDetails);
                    // Add your logic to display order details
                });
            });
        });
    });
