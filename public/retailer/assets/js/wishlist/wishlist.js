                ...
                response.wishlist.forEach((item) => {
                    ...
                    <input type="hidden" name="stock${
                        item.product_id
                                    ...
                                    value="1">
                        <a href="${productDetailUrl}" ><img class="square bg-white p-2" src="${baseurl}/${
                  ...
                  <td>
                    <div class="badge ${
                        ...
                        item.stock ? `IN STOCK - ${item.stock}` : "OUT OF STOCK"
                    } 
                    </div>
                  </td>
                 ...
                 <td>
                  <button type="button" onclick="addforcart(${
                      item.product_id
                  })" class="btn wishlist_add-to-cart-btn d-flex justify-content-center align-items-center" ${
                        item.stock ? "" : "disabled"
                    }>Add to Cart </button>
                    </td>
        ...
        success: function (response) {
            ...
            if (response.wishlist.length === 0) {
                mobileWishlistContainer.innerHTML =
                    "<img src='" + baseurl + "/emptycart.gif' alt=''>";
            } else {
                ...
                response.wishlist.forEach((item, index) => {
                    ...
                    var eid = $("#encrypt" + item.product_id).val();
                    let productDetailUrl = "productdetail/productId".replace(
                        "productId",
                        eid
                    );
                    console.log(productDetailUrl, "item");
                    ...
                    <div class="d-flex justify-content-between">
                      <div class="d-flex gap-2">
                        ...
                        item.product_name
                              ...
                              <div class="input-group quantity-input-group quantity-container my-2" style="margin: 0px;">
                                <input type='button' value='-' class='qtyminus' onclick="decrementQuantity(this)" field='quantity' data-id='${
                                    item.product_id
                                }' />
                                ...
                                <div class="wishlist_add-to-cart-btn_wrapper">
                                  <button onclick="addforcart(${
                                      item.product_id
                                  })" class="btn wishlist_add-to-cart-btn" ${
                        item.stock ? "" : "disabled"
                    }>Add to Cart</button>
                                </div>
