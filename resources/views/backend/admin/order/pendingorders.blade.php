...
<section class="section">
    <div class="row">
        <div class="col-12 mb-4">
            <div class="h2 page-main-heading">Approved Starting</div>
        </div>
    </div>
    <div class="row">
        <div class="col-12 mb-4">
                ...
                <div class="d-flex flex-wrap align-items-center ">
                    <div class="button-group custom-btn-border bg-transparent">
                        <button type="button" class="btn btn-default btn-sm dropdown-toggle  bg-transparent"
                            data-toggle="dropdown"><i class="fas fa-filter"></i> Filter by <span
                        ...
                        <table class="table table-striped" id="table-2">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>999-5878</td>
                                    <td>
                                        <div>Premlata Silver L..</div>
                                        <div>SD. Akshay Jew..</div>
                                    </td>
                                    <td>Electro Form.. (+3)</td>
                                    <td>C023-10059628</td>
                                    <td>
                                        <div class="badge pending-badge">Pending</div>
                                    </td>
                                    <td>Aug 13, 2023</td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="#" class="mr-2">
                                                <img src="{{ asset('backend/assets/img/icons/whatsapp.png') }}"
                                                    alt=""></a>
                                            <a href="#" class="mr-2">
                                                <img src="{{ asset('backend/assets/img/icons/sms.png') }}"
                                                    alt=""></a>
                                            <a href="#" class="">
                                                <img src="{{ asset('backend/assets/img/icons/mail.png') }}"
                                                    alt=""></a>
                                        </div>
                                    </td>
                                </tr>
