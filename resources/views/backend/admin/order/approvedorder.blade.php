...
@section('content')
@section('title')
    Approved Orders - Emerald DMS Dashboard
@endsection
<style>
    .order-page-card1 {
...
<section class="section">
    <div class="row">
        <div class="col-6 mb-4">
            <div class="h2 page-main-heading">Approved Orders</div>
        </div>
        <div class="col-6 text-right">
            <button data-bs-toggle="tooltip" data-placement="top" title="Import" type="button" class="btn btn-success"
                data-toggle="modal" data-target="#basicModal">Export</button>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" style="width:100%" id="approvedorder">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th width="110" class="text-light">Order Copy</th>
                                    <th width="110" class="text-light m-auto">Order Details</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<div class="modal fade" id="basicModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Export Stock</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="modal-body">
                    <form action="{{ route('exportstock') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <input type="date" class="form-control" name="stockexport" id="stockexport" required>
                        </div>
...
@section('scripts')
    <script src="{{ asset('backend\assets\js\admin\order\approvedorder.js') }}"></script>
@endsection
@endsection
