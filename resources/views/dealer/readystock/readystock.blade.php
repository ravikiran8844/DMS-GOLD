...
@section('title')
    ...
    @elseif($currentUrl == route('sivishnu'))
        Electroforming/Vishnu
    @elseif($currentUrl == route('efreadystock'))
        Electroforming/Ready Stock
    @elseif($currentUrl == route('sireadystock'))
        Solididol/Ready Stock
    @elseif($currentUrl == route('jewelleryreadystock'))
        Jewellery/Ready Stock
    @elseif($currentUrl == route('indianiareadystock'))
        Indiania/Ready Stock
    @elseif($currentUrl == route('utensilreadystock'))
        Utensil/Ready Stock
    @elseif($currentUrl == route('efstock'))
        Electroforming
    @elseif($currentUrl == route('sistock'))
        Solididol
    @elseif($currentUrl == route('jewellerystock'))
        Jewellery
    @elseif($currentUrl == route('indianiastock'))
        Indiania
    @elseif($currentUrl == route('utensilstock'))
        Utensil
    @elseif($currentUrl == route('search'))
        search
    @endif- Emerald DMS
@endsection
@section('header')
...
<div class="single-banner-container">
    @if ($currentUrl == url('/sireadystock') && isset($banners[0]))
        <img class="img-fluid w-100" src="{{ asset($banners[1]->banner_image) }}" alt="banner">
    @elseif($currentUrl == url('/efreadystock') && isset($banners[1]))
            ...
            <div class="mobile-filters-offcanvas__body">
                <div class="mobile-filters-offcanvas__body-items">
                    <div class="mobile-filters-offcanvas__body-item-filter-labels">
                        <div class="nav flex-column" id="mob-filters-tab" role="tablist" aria-orientation="vertical">
                            ...
                            @if ($currentProjectId == App\Enums\Projects::SOLIDIDOL || $currentProjectId == App\Enums\Projects::ELECTROFORMING)
                                        ...
                                        @foreach ($others as $other)
                                            <div class="form-check d-flex justify-content-between gap-2">
                                                <div>
                                                    ...
                                                    <label class="form-check-label" for="other{{ $other->id }}">
...
<div class="container container-lg-fluid">
    <div class="row g-0">
        {{-- Sidebar --}}
        @include('dealer.readystock.sidebar')
        {{-- product list --}}
        <section class="col-lg-9 col-xxl-10 p-lg-2">
            ...
            <div class="product-cards_wrapper position-relative">
                    ...
                    <div class="text-center d-flex flex-column h-100 justify-content-center align-items-center">
                        <div class="mb-2">
                            <img class="spinner-image" width="60" height="60"
                                src="{{ asset('dealer/img/loader.png') }}" alt="">
                        </div>
                        <div>Please wait!</div>
                    </div>
                </div>
                ...
                <div class="row">
                                ...
                                <div class="card shop-page_product-card">
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <button
                                                ...
                                                <svg width="26" height="23" viewBox="0 0 26 23"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#667B68" stroke-width="1.5"
                                        ...
                                        {{-- @if ($stock == 1)
                                            ...
                                            @endphp
                                            <div
                                                class="d-flex my-2 flex-wrap gap-2 align-items-center justify-content-between">
                    ...
                    @endif --}}
                                        ...
                                        @endphp
                                        <div
                                            class="d-flex mt-2 flex-wrap gap-2 align-items-center justify-content-between">
                                            @if (
                                                $item->project_id == App\Enums\Projects::ELECTROFORMING ||
                                                    $stock == 1 ||
                                                    ($item->project_id == App\Enums\Projects::SOLIDIDOL && Str::startsWith($item->product_unique_id, 'CSSIDOL')))
                                                @php
                                                    $mc =
                                                        $item->project_id == App\Enums\Projects::ELECTROFORMING ||
                                                        $stock == 1
                                                            ...
                                                            : 'C*';
                                                @endphp
                                                <div class="text-success">Tag Code : <span
                                                        class="fw-semibold">{{ $mc }}</span></div>
                                            @elseif ($item->project_id == App\Enums\Projects::SOLIDIDOL && Str::startsWith($item->product_unique_id, 'CSSIDOL'))
                                                @php
                                                    $mc = 'C*';
                                                @endphp
                                                <div class="text-success">Tag Code : <span
                                            ...
                                            @else
                                                @php
                                                $mc = $item->weight < 20 ? 'G' : 'F'; @endphp @if ($item->project_id == App\Enums\Projects::SOLIDIDOL)
                                                    <div class="text-success">Tag Code : <span
                                                            class="fw-semibold">{{ $mc }}</span></div>
                                                @endif
                                            @endif
                                        ...
                                        <div>
                                            ...
                                            @if (($projectId == App\Enums\Projects::SOLIDIDOL || $projectId == App\Enums\Projects::ELECTROFORMING) && $stock == 0)
                                                <div class="card-text mt-2">MOQ: {{ $item->moq }} pcs</div>
                                            @elseif ($stock == 1 && $item->qty > 0)
                                                <div class="product-cart-qty-text mt-2">In Stock:
...
@section('scripts')
    <script src="{{ asset('dealer\js\readystock\readystock.js') }}"></script>
    ...
    <!-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            var showMoreButton = document.getElementByI d('showMore');
