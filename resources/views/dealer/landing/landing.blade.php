            ...
            <ul class="splide__list">
                <li class="splide__slide">
                    <picture>
                        ...
                        <!-- Fallback image -->
                        <img height="358" src="{{ asset($banner->banner_image) }}" alt="slide" class="img-fluid w-100">
                    </picture>
                </li>
            </ul>
    ...
    <section class="container" id="ef-ready-stock">
        <div class="row py-4 py-lg-5">
            ...
            <div
                ...
                <div>
                    <a href="{{ route('efreadystock') }}" class="btn view-all-btn ">View All
                ...
                <div class="home-products-grid">
                    <div class="home-products-grid-item">
                        ...
                        <div class="home-products-grid-item__img-wrapper">
                            <img class="img-fluid"
                                    src="{{ asset('dealer/img/new-home/electro-forming-img1.png') }}"
                                    alt="">
                        </div>
                        </a>
                    ...
                    <div class="home-products-grid-item">
                        ...
                        <div class="home-products-grid-item__img-wrapper">
                                ...
                                <img class="img-fluid"
                                    src="{{ asset('dealer/img/new-home/electro-forming-img2.png') }}" alt="">
                    ...
                    <div class="home-products-grid-item">
                        ...
                        <div class="home-products-grid-item__img-wrapper">
                                ...
                                <img class="img-fluid"
                                    src="{{ asset('dealer/img/new-home/electro-forming-img3.png') }}" alt="">
                    ...
                    <div class="home-products-grid-item">
                        ...
                        <div class="home-products-grid-item__img-wrapper">
                                ...
                                <img class="img-fluid"
                                    src="{{ asset('dealer/img/new-home/electro-forming-img4.png') }}" alt="">
                    ...
                    <div class="home-products-grid-item">
                        ...
                        <div class="home-products-grid-item__img-wrapper">
                                ...
                                <img class="img-fluid"
                                    src="{{ asset('dealer/img/new-home/electro-forming-img5.png') }}" alt="">
    ...
    <section class="container" id="solid-ready-stock">
        <div class="row  py-4 py-lg-5">
            ...
            <div
                ...
                <div>
                    <a href="{{ route('sireadystock') }}" class="btn view-all-btn ">View
                        All
                        <span> <svg width="18" height="12" viewBox="0 0 23 12" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="home-products-grid">
                    <div class="home-products-grid-item">
                        <a href="{{ route('siganesha') }}">
                            <div class="home-products-grid-item__img-wrapper">
                                ...
                                <img class="img-fluid"
                                    src="{{ asset('dealer/img/new-home/solid-idol-1.jpg') }}" alt="">
                    ...
                    <div class="home-products-grid-item">
                        <a href="{{ route('sihanuman') }}">
                            <div class="home-products-grid-item__img-wrapper">
                                    ...
                                    <img class="img-fluid"
                                        src="{{ asset('dealer/img/new-home/solid-idol-2.jpg') }}" alt="">
                    ...
                    <div class="home-products-grid-item">
                        <a href="{{ route('sikrishna') }}">
                            <div class="home-products-grid-item__img-wrapper">
                                    ...
                                    <img class="img-fluid"
                                        src="{{ asset('dealer/img/new-home/solid-idol-3.jpg') }}" alt="">
                    ...
                    <div class="home-products-grid-item">
                        ...
                        <div class="home-products-grid-item__img-wrapper">
                                ...
                                <img class="img-fluid"
                                    src="{{ asset('dealer/img/new-home/solid-idol-4.jpg') }}" alt="">
                    ...
                    <div class="home-products-grid-item">
                        ...
                        <div class="home-products-grid-item__img-wrapper">
                                ...
                                <img class="img-fluid"
                                    src="{{ asset('dealer/img/new-home/solid-idol-5.jpg') }}" alt="">
            ...
            <div class="row gx-lg-5">
                <div class="col-12 col-md-4 col-lg-6">
                    <img class="img-fluid h-100 object-fit-cover rounded-4 w-100" width="850" height="688"
                        src="{{ asset('dealer/img/new-home/emerald-jewel-industry.webp') }}" alt="">
                </div>
                    ...
                    <div class="d-flex flex-column justify-content-between h-100">
                        ...
                        <div class="row mt-4">
                            <div class="col-12 col-md-3 col-lg-4">
                                <img class="img-fluid h-100 object-fit-cover rounded-4 w-100" width="246" card-header 265
                                    src="{{ asset('dealer/img/new-home/SRINIVASAN.png') }}" alt="" srcset="">
                            </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img width="191" height="135" class="img-fluid"
                                src="{{ asset('dealer/img/new-home/logo-section-img1.png') }}" alt="">
                        </div>
                        <div class="swiper-slide">
                            <img width="191" height="135" class="img-fluid"
                                src="{{ asset('dealer/img/new-home/logo-section-img2.png') }}" alt="">
                        </div>
                        <!-- <div class="swiper-slide">
                            <img width="191" height="135" class="img-fluid"
                                src="{{ asset('dealer/img/new-home/logo-section-img3.png') }}" alt="">
                        </div> -->
                        <div class="swiper-slide">
                            <img width="191" height="135" class="img-fluid"
                                src="{{ asset('dealer/img/new-home/logo-section-img4.png') }}" alt="">
                        </div>
                        <div class="swiper-slide">
                            <img width="191" height="135" class="img-fluid"
                                src="{{ asset('dealer/img/new-home/logo-section-img5.png') }}" alt="">
                        </div>
