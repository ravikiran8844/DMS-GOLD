                            ...
                            <div class="col-12 mb-5">
                                <div class="card order-details-card">
                                    <div
                                        ...
                                        <div>
                                            {{-- <button class="btn btn-light order-status-btn">Status: <span
                                                    class="text-success">{{ $status->status }}</span></button> --}}
                                            ...
                                            <table class="table  table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center">Weight per product (in gms)</th>
                                                    ...
                                                    @foreach ($orderdetails as $item)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center"
                                                                style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 16ch; cursor:pointer"
                                                                title="{{ $item->remarks == null ? '-' : $item->remarks }}">
