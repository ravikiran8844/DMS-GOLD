...
<div id="catalog-slider-section">
	...
	<html lang="en">
		...
		<style>
			...
			.products-grid__item-img-wrapper {
		...
		<body id="previewmode">
			<main>
				...
				<div class="pdfsect pdfsect_{{$ic}}">
								...
								<div class="products-grid">
									...
									<div class="products-grid__item">
										<div class="products-grid__item-img-wrapper">
											<img class="img-fluid" src="{{ asset('frontend/catelogue/uploads13042024/' . $product[0].'.jpg') }}" alt="" width="200" height="200">
										</div>
										<div>
											<div class="fw-semibold">{{ substr($product[5],0,15)."..." }}</div>
											<div class="fw-semibold">{{ $product[0] }}</div>
											<div>
											    <span class="fw-semibold">Wt.</span><span class="fw-seminor">{{ $product[2] }}g</span>
												<span class="fw-semibold">Wdh.</span><span class="fw-seminor">{{ $product[3] }}</span>
												<span class="fw-semibold">Hgt.</span><span class="fw-seminor">{{ $product[4] }}</span>
												<span class="fw-semibold">S.N.</span><span class="fw-seminor">{{ $product[1] }} </span>
											</div>
										</div>
									</div>
									@if($ic % 12 == 0)
					...
					$iq++;
					@endphp
					</div><div class="pdfsect pdfsect_{{$iq}}">
					@endif
					<section class="header-section">
						<div class="container p-4">
							<div class="col-12 d-flex flex-wrap gap-4 justify-content-between align-items-center">
										...
										<div class="container py-5">
											<div class="col-12">
												<div class="products-grid">
													<div class="products-grid__item">
														<div class="products-grid__item-img-wrapper">
															<img class="img-fluid" src="{{ asset('frontend/catelogue/images/productholder.png') }}" alt="" width="200" height="200">
														</div>
														<div>
															<div class="fw-semibold">*************
															</div>
															<div class="fw-semibold">----------</div>
															<div><span class="fw-semibold">Weight: </span><span class="fw-seminor">0g</span>
																<span class="fw-semibold">MC Tag code: </span><span class="fw-seminor">**</span>
															</div>
														</div>
													</div>
													<div class="products-grid__item">
					...
					<script>
						document.addEventListener("DOMContentLoaded", function() {
							...
							downloadButton.addEventListener('click', function() {
								...
								function splitAndConvertToPdf(htmlElementIds,html2pdf) {
									htmlElementIds.forEach(async (id) => {
								...
								const pdfSectCount = document.querySelectorAll('.pdfsect').length;
								for(var i=0;i<pdfSectCount;i++){
									var qa = i+1;
									elementIds.push(".pdfsect_"+qa);
								}
								splitAndConvertToPdf(elementIds,html2pdf);	
							});
						});
					</script>					