...
<div id="catalog-slider-section">
	...
	<html lang="en">
		...
		<head>
			...
			<link rel="stylesheet" href="{{ asset('/frontend/catelogue1/style.css') }}" /> 
		</head>
		<body id="body">
							...
							<div class="grid-item">
								<div class="card">
									<div class="card-header text-center">
										<div class="card-main-title">{{ $product[0] }}</div>
									</div>
									...
									<div class="card-body card-text">
										...
										<div class="mt-2">Sketch Number : <span>{{ $product[1] }}</span>
										</div>
									</div>
								</div>
							</div>
	...
	document.addEventListener("DOMContentLoaded", function() {
		...
		downloadButton.addEventListener('click', function() {
			...
			const opt = {
				...
				html2canvas:  { scale: 2, useCORS: true }, // Enable background graphics
				// html2canvas: {
					// dpi: 192,
					// scale:4,
