...
<head>
    ...
    <script>
        ...
        fbq('init', '1813581095715489');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=1813581095715489&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
    <!-- Google Tag Manager -->
    <script>
        (function(w, d, s, l, i) {
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-TGVNGG5K');
    </script>
    <!-- End Google Tag Manager -->
    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TGVNGG5K" height="0" width="0"
    ...
    <link rel="stylesheet" href="{{ asset('retailer/assets/lib/css/splide.min.css') }}">
    <link rel="stylesheet" href="{{ asset('retailer/assets/css/menu.css') }}">
    <link rel="stylesheet" href="{{ asset('retailer/assets/css/custom.css') }}">
    <link rel="stylesheet" href="{{ asset('retailer/assets/css/new-styles.css') }}">
    <link rel="stylesheet" href="{{ asset('retailer/assets/lib/css/fontawesome/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('retailer/assets/lib/css/fontawesome/css/fontawesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('retailer/assets/lib/css/dataTables.css') }}">
    <link rel="stylesheet" href="{{ asset('retailer/assets/lib/css/daterangepicker.css') }}">
    <link rel="stylesheet" href="{{ asset('retailer/assets/lib/css/select.dataTables.min.css') }}">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-JDB57DKM9W"></script>
    <script>
    ...
    <script>
        (function(w, d, s, l, i) {
            ...
            j.src =
                'https://www.googletagmanager.com/gtm.js?id=' + i + dl;
            f.parentNode.insertBefore(j, f);
        })(window, document, 'script', 'dataLayer', 'GTM-MNS6THGB');
    </script>
...
<body>
    ...
    <header class="mb-0">
        ...
        @php
            ...
            $containsRetailerCart = Str::contains($currentUrl, 'retailer/cart');
            $setting = App\Models\Settings::first();
        @endphp

        <!-- @if (request()->url() != $containsRetailerCart)
<section class="container py-2 d-block d-xl-none">
                <div class="d-flex flex-wrap justify-content-center align-items-center gap-2">
                    <div>
                        <a class="btn rk-custom-btn px-4 efreadystock" href="{{ route('retailerefreadystock') }}">EF
                            Idol</a>
                    </div>
                    <div>
                        <a class="btn rk-custom-btn px-4 sireadystock" href="{{ route('retailersireadystock') }}">Solid
                            Idol</a>
                    </div>
                </div>
            </section>
@endif -->
            ...
            <div class="modal-content" style="background-color: #F8F9FA;">
                <div class="modal-body d-flex align-items-center">
                    <div class="flex-grow-1">
                        <form action="{{ route('retailersearch') }}" method="GET" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <button class="btn" type="submit">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22"
                                            ...
                                            <path
                                                ...
                                                fill="#667B68" stroke="#F8EDE3" stroke-width="0.4"></path>
                                        </svg>
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="card border-0">
                        <div class="card-body  position-relative">
                            ...
                            <div class="position-absolute start-0 top-0">
                                <img width="75" class="img-fluid" src="/retailer/assets/img/login-card-logo.svg"
                                    alt>
                            </div>
                            <!-- Login Screen -->
                            <div id="loginScreen" class="screen active">
                                ...
                                <div class="col-12 d-flex flex-row gap-4 justify-content-center pb-3">
                                    <div class="text-center mt-4">
                                        <div class="fs-5 poppins">WELCOME TO </div>
                                        <div class="fs-3 fw-bold mt-2 poppins">EMERALD JEWEL INDUSTRY</div>
                            ...
                            <div id="otpScreen" class="screen">
                                <div class="position-absolute start-0">
                                    <button class="btn btn-icon" onclick="showLoginScreen()">
                                        <svg width="32" height="32" viewBox="0 0 44 44" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <rect x="0.5" y="0.5" width="43" height="43" rx="7.81111"
                                                fill="white" stroke="#C2C2C2"></rect>
                                            <path
                                                d="M13.3541 21.419L18.3082 15.8458C18.5671 15.5822 18.9432 15.5845 19.1838 15.8023C19.4245 16.0201 19.4452 16.4373 19.2274 16.6779L15.1925 21.2158H31.1576C31.4996 21.2158 31.7769 21.493 31.7769 21.8351C31.7769 22.1771 31.4996 22.4543 31.1576 22.4543H15.1925L19.2274 26.9921C19.4452 27.2328 19.4173 27.6423 19.1838 27.8678C18.9408 28.1026 18.526 28.0649 18.3082 27.8242L13.3541 22.2511C13.1353 21.9452 13.1614 21.686 13.3541 21.419Z"
                                                fill="#2D2D2D"></path>
                                        </svg>
                                    </button>
                                </div>
                                <div class="col-12 text-center mt-5">
                                    ...
                                    <div class="mb-4 light-text">Code is sent to
                                    ...
                                    <form id="otpForm" action="{{ route('retailerloginverfication') }}"
                                        ...
                                        @php
                                            $userToken = Illuminate\Support\Facades\Cookie::get('mobile');
                                            $sessionmobile = Illuminate\Support\Facades\Session::get('mobile');
                                            $role_id = App\Models\User::where('mobile', $sessionmobile)->value(
                                                'role_id',
                                            );
                                        @endphp
                                        <input type="hidden" name="hdroleid" id="hdroleid"
                                            value="{{ $role_id }}">
                                        <input type="hidden" name="otpexpiry" id="otpexpiry"
                                            value="{{ $setting->otp_expiry_duration }}">
                                        <input type="hidden" name="authmob" id="authmob" value="">
                                        @csrf
                                        <div class="mb-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div id="resendLinkContainer" class="text-warning fs-6">
                                                <a class="resend-text text-decoration-none fw-medium"
                                                    onclick="restartTimer()">Resend</a>
                                            </div>
                            ...
                            <div id="signupScreen" class="screen">
                                ...
                                <form id="signupForm" action="{{ route('retailerregisterstore') }}" method="POST">
                                    ...
                                    <div class="col-12 mt-4">
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-12 mt-4">
                                                <label class="form-label fw-medium" for="dealerName">If you are
                                                    ...
                                                    existing <span class="fw-bold">AUTHORISED EMERALD DEALERS</span>,
                                                    Please enter their name</label>
                                        ...
                                        <div id="signupErrorMessage" class="error-message mt-3 text-center"
                                            style="display: none">
                                        ...
                                        <div class="col-12 text-center">
                                            <div
                                                class="d-flex justify-content-center align-items-center mt-4 mb-2 gap-2">
                                                <input type="checkbox" checked class="form-check" name="terms"
                                                    id="agree-terms">
                                                <label for="agree-terms" class="form-label fs-6">I agree with <span
                                                        class="fw-bold">Terms & Conditions</span> of Emerald Jewel
                                                    Industry</label>
                                            </div>
                                            <div class="mb-3">
                                                <button type="button" class="btn sign-up-page_btn"
    ...
    {{-- @php
        $internetSpeed = session('internet_speed');
        echo "User's internet speed: {$internetSpeed} Mbps";
    @endphp --}}


    <a class="no-login-required" style=" position: fixed; bottom: 150px; right: 10px; z-index: 9999; "
        target="_blank"
    ...
    <!--
    <div id="whatsapp-contact" style="cursor: pointer; position: fixed; bottom: 150px; right: 10px; z-index: 9999; ">
        <img src="{{ asset('retailer/assets/img/whatsapp.png') }}" width="42" height="42"
            alt="whatsapp icon">
    </div> -->
    <!-- <script>
        document.addEventListener("DOMContentLoaded", function() {
            document.getElementById("whatsapp-contact").addEventListener("click", function() {
                console.log("clicked");
                window.open(
                    'https://api.whatsapp.com/send?phone=919791714333&text=I%20have%20questions%20regarding%20Retailer%20Management%20System',
                    '_blank');
            });
        });
    </script> -->
    ...
    <script src="{{ asset('retailer/assets/lib/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('retailer/assets/lib/js/splide.min.js') }}"></script>
    <script src="{{ asset('retailer/assets/js/smartmenu.js') }}"></script>
    <script src="{{ asset('retailer/assets/js/custom.js') }}"></script>
    <script src="{{ asset('retailer/assets/js/login/login.js') }}"></script>
    <script src="{{ asset('common/common.js') }}"></script>
    <script src="{{ asset('retailer\assets\lib\js\toastr.js') }}"></script>
    <script src="{{ asset('retailer/assets/lib/js/moment.min.js') }}"></script>
    <script src="{{ asset('retailer/assets/lib/js/daterangepicker.min.js') }}"></script>
    <script src="{{ asset('retailer/assets/lib/js/dataTables.js') }}"></script>
    ...
    {{-- <script>
        function measureInternetSpeed() {
            ...
            const fileSizeInBytes = 102400; // Size of the test image in bytes

            image.src = "http://localhost:8000/retailer/assets/img/logo.svg";

            image.onload = function() {
                const endTime = new Date().getTime();
                const duration = (endTime - startTime) / 1000; // Time in seconds
                const bitsLoaded = fileSizeInBytes * 8;
                const speedInBps = (bitsLoaded / duration).toFixed(2); // Speed in bps
                const speedInKbps = (speedInBps / 1024).toFixed(2); // Speed in kbps
                const speedInMbps = (speedInKbps / 1024).toFixed(2); // Speed in Mbps

                console.log(`Internet speed: ${speedInMbps} Mbps`);
                sendSpeedToServer(speedInMbps);
            };
        ...
        function sendSpeedToServer(speed) {
            // Send the speed to your Laravel backend
            fetch('/save-internet-speed', {
                    method: 'POST',
                    headers: {
    ...
    // Run the speed test when the page loads
    window.onload = measureInternetSpeed;
    </script> --}}
    @yield('scripts')
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MNS6THGB" height="0" width="0"
            style="display:none;visibility:hidden"></iframe></noscript>
