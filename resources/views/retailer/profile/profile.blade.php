                ...
                <div class="row">
                    <div class="col-12 col-md-3 col-lg-3 col-xxl-2">
                        <div class="nav flex-row flex-md-column nav-pills me-3" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link active" href="{{ route('retailermyprofile') }}">My Profile</a>
                            <a class="nav-link" href="{{ route('retailerorders') }}">Orders</a>
                            <a class="nav-link d-none d-md-inline" href="{{ route('retailerlogout') }}">Logout</a>
                        </div>
                    </div>
                    <div class="col-12 col-md-9 col-lg-9 col-xxl-10 mt-4 mt-md-0">
                        <div class="row custom-card">
                            <div class="col-12">
                                <form action="{{ route('retailerprofileupdate') }}" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-4 d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                            <a class="d-md-none btn btn-outline-dark" href="{{ route('retailerlogout') }}" style=" border: 1px solid #6C6C6C !important; border-radius: 6px !important; "><svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
