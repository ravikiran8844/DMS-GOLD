                ...
                <div class="row">
                    <div class="col-12 col-md-3 col-lg-3 col-xxl-2">
                        <div class="nav flex-row flex-md-column nav-pills me-3" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link" href="{{ route('retailermyprofile') }}">My Profile</a>
                            <a class="nav-link active" href="{{ route('retailerorders') }}">Orders</a>
                            <a class="nav-link" href="{{ route('retailerlogout') }}">Logout</a>
                        </div>
                    </div>
...
@endsection
@section('scripts')
<script src="{{ asset('retailer/assets/js/order/order.js') }}"></script>
@endsection
