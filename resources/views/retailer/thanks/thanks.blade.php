...
<section class="container py-5">
    <div class="row">
        <div class="col-12 text-center">
            ...
            <img width="161" height="152" class="img-fluid" src="assets/img/thankyou.png" alt="">

            <div class="fw-semibold fs-5 mt-4">Your order Id is <span class="text-success">{{ $order_no }}</span> &
        ...
        {{-- <div class="col-12 col-lg-10 col-xl-8 mt-4 m-auto">
            ...
            <div class="mt-4 p-3 p-lg-4"
                style="border: 0.78px solid #003836; background: #00383633; border-radius: 10px;">
                ...
                <div class="mt-4 p-3 text-white" style=" background: #003836; border-radius: 10px; ">
